...
export default function FileOptimized({ text, paragraph }) {
  return (
      <div id="tasks-automated-section">
        <div className="tasks-automated-content">
          <h3>{text}</h3>
          <p>{paragraph}</p>
        </div>
        {/* <div className="tasks-container">
          <ul className="logogrid">
            ...
            <li className="logogrid__item">
              <img className="logogrid__img" src={NasaLogo} alt="nasa-logo" />
            </li>
            <li className="logogrid__item">
              <img className="logogrid__img" src={IbmLogo} alt="Ibm-logo" />
            </li>
            <li className="logogrid__item">
              <img
                className="logogrid__img"
            ...
            <li className="logogrid__item">
              <img className="logogrid__img" src={NikeLogo} alt="nike-logo" />
            </li>
            <li className="logogrid__item">
              <img className="logogrid__img" src={EbayLogo} alt="ebay-logo" />
            </li>
            <li className="logogrid__item">
              <img
                className="logogrid__img"
            ...
            <li className="logogrid__item">
              <img className="logogrid__img" src={LyftLogo} alt="lyft-logo" />
            </li>
            <li className="logogrid__item">
              <img
                className="logogrid__img"
