    ...
    <ProtectedRoute>
      <div className="profile-page-wrapper">
        <div className="profile-container">
          <Sidebar />
          <section>
            <div className="profile-page-heading">Web Pro</div>
                ...
                <div className="subscription-features-row">
                  <ul>
                    <li>
                      ...
                      Batch compress 100 images with Pro.
                    </li>
                    <li>
                      {" "}
                      <img src="/images/blue-tick.png" />
                      Compress 100 PDFs at once with Pro
                    </li>
                    <li>
                      {" "}
                      <img src="/images/blue-tick.png" />
                      Pro version allows 100MB PDFs, 50MB images.
                    </li>
                  </ul>
                </div>
              </div>
